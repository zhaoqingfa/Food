package com.zqf.food.common.log;

import android.support.annotation.Nullable;
import android.text.TextUtils;

import com.zqf.food.common.log.klog.BaseLog;
import com.zqf.food.common.log.klog.FileLog;
import com.zqf.food.common.log.klog.JsonLog;
import com.zqf.food.common.log.klog.XmlLog;
...
public final class LogUtil {
    ...
    private static void printStackTrace() {
        ...
        for (String trace : traceString) {
            if (trace.contains("at " + LogUtil.class.getPackage().getName() + "."
                    + LogUtil.class.getSimpleName())) {
                continue;
            }
    ...
    private static String[] wrapperContent(int stackTraceIndex, String tagStr, Object... objects) {
        // TODO new Throwable().getStackTrace()的性能相对比Thread.currentThread().getStackTrace()好
        // Thread.currentThread().getStackTrace()下标是 4,5
        // new Throwable().getStackTrace()下标是 2，3
